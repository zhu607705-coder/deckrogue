...
const CARD_ROUTE_SIGNALS_BY_ID: Record<string, CardRouteSignalDef> = {
  ...
  // Wave II full-scale route deepening
  cipher_dead_drop: { routeTags: ['informant:intel'], routeSignalStrength: 3, earlyGameRole: 'route_confirm' },
  shadow_ledger_route: { routeTags: ['informant:stealth'], routeSignalStrength: 3, earlyGameRole: 'route_confirm' },
  witness_box_trap: { routeTags: ['informant:evidence'], routeSignalStrength: 4, earlyGameRole: 'route_payoff' },
  sainted_sinew: { routeTags: ['brute:strength'], routeSignalStrength: 3, earlyGameRole: 'route_confirm' },
  nailwall_stance: { routeTags: ['brute:block'], routeSignalStrength: 3, earlyGameRole: 'route_confirm' },
  redline_bellow: { routeTags: ['brute:rage'], routeSignalStrength: 4, earlyGameRole: 'route_payoff' },
  venom_grid: { routeTags: ['tactician:poison'], routeSignalStrength: 3, earlyGameRole: 'route_confirm' },
  command_canticle: { routeTags: ['tactician:command'], routeSignalStrength: 3, earlyGameRole: 'route_confirm' },
  bastion_geometry: { routeTags: ['tactician:formation'], routeSignalStrength: 4, earlyGameRole: 'route_payoff' },
  choir_thread: { routeTags: ['puppeteer:threads'], routeSignalStrength: 3, earlyGameRole: 'route_confirm' },
  reliquary_golem: { routeTags: ['puppeteer:summon'], routeSignalStrength: 3, earlyGameRole: 'route_confirm' },
  severance_pact: { routeTags: ['puppeteer:sacrifice'], routeSignalStrength: 4, earlyGameRole: 'route_payoff' },
  minute_tax: { routeTags: ['chronomancer:time_layer'], routeSignalStrength: 3, earlyGameRole: 'route_confirm' },
  delayed_funeral: { routeTags: ['chronomancer:delay'], routeSignalStrength: 3, earlyGameRole: 'route_confirm' },
  warp_notary: { routeTags: ['chronomancer:warp'], routeSignalStrength: 4, earlyGameRole: 'route_payoff' },
  ember_distillate: { routeTags: ['alchemist:fire'], routeSignalStrength: 3, earlyGameRole: 'route_confirm' },
  acidic_catechism: { routeTags: ['alchemist:acid'], routeSignalStrength: 3, earlyGameRole: 'route_confirm' },
  choir_reagent: { routeTags: ['alchemist:concoction'], routeSignalStrength: 4, earlyGameRole: 'route_payoff' },
  docket_of_bones: { routeTags: ['penitent_judge:verdict'], routeSignalStrength: 3, earlyGameRole: 'route_confirm' },
  execution_hour: { routeTags: ['penitent_judge:execution'], routeSignalStrength: 4, earlyGameRole: 'route_payoff' },
  compelled_confession: { routeTags: ['penitent_judge:confession'], routeSignalStrength: 3, earlyGameRole: 'route_confirm' },
  seal_of_stillwater: { routeTags: ['void_sanctioner:seal'], routeSignalStrength: 3, earlyGameRole: 'route_confirm' },
  suppression_field: { routeTags: ['void_sanctioner:suppression'], routeSignalStrength: 4, earlyGameRole: 'route_payoff' },
  rift_liability: { routeTags: ['void_sanctioner:risk'], routeSignalStrength: 3, earlyGameRole: 'route_confirm' },
};
...
const EVENT_ROUTE_SIGNALS_BY_ID: Record<string, EventRouteSignalDef> = {
  ...
  cipher_bazaar: {
    routeTags: ['informant:intel', 'informant:stealth', 'informant:evidence'],
    reinforcement: 'confirm',
    preferredChoiceRoles: {
      cipher_bazaar_decode: 'confirm',
      cipher_bazaar_shadow: 'pivot',
      cipher_bazaar_blackmail: 'payoff',
    },
  },
  redoubt_of_nails: {
    routeTags: ['brute:strength', 'brute:block', 'brute:rage'],
    reinforcement: 'support',
    preferredChoiceRoles: {
      redoubt_lift_rebar: 'confirm',
      redoubt_hold_gate: 'support',
      redoubt_break_oath: 'payoff',
    },
  },
  banner_court: {
    routeTags: ['tactician:poison', 'tactician:command', 'tactician:formation'],
    reinforcement: 'confirm',
    preferredChoiceRoles: {
      banner_poison_wind: 'pivot',
      banner_issue_order: 'confirm',
      banner_lock_formation: 'payoff',
    },
  },
  string_scriptorium: {
    routeTags: ['puppeteer:threads', 'puppeteer:summon', 'puppeteer:sacrifice'],
    reinforcement: 'support',
    preferredChoiceRoles: {
      scriptorium_splice_thread: 'confirm',
      scriptorium_wake_shell: 'support',
      scriptorium_cut_strings: 'payoff',
    },
  },
  hourglass_morgue: {
    routeTags: ['chronomancer:time_layer', 'chronomancer:delay', 'chronomancer:warp'],
    reinforcement: 'support',
    preferredChoiceRoles: {
      morgue_tax_minute: 'confirm',
      morgue_delay_debt: 'support',
      morgue_warp_record: 'payoff',
    },
  },
  choir_crucible: {
    routeTags: ['alchemist:fire', 'alchemist:acid', 'alchemist:concoction'],
    reinforcement: 'payoff',
    preferredChoiceRoles: {
      crucible_feed_ember: 'confirm',
      crucible_distill_acid: 'pivot',
      crucible_bind_formula: 'payoff',
    },
  },
  verdict_catacomb: {
    routeTags: ['penitent_judge:verdict', 'penitent_judge:execution', 'penitent_judge:confession'],
    reinforcement: 'confirm',
    preferredChoiceRoles: {
      catacomb_read_docket: 'confirm',
      catacomb_ring_bell: 'payoff',
      catacomb_take_confession: 'support',
    },
  },
  null_well: {
    routeTags: ['void_sanctioner:seal', 'void_sanctioner:suppression', 'void_sanctioner:risk'],
    reinforcement: 'support',
    preferredChoiceRoles: {
      null_well_seal_surface: 'confirm',
      null_well_lower_cage: 'payoff',
      null_well_drink_silence: 'pivot',
    },
  },
};
...
const ROUTE_TAXONOMY_BY_TAG: Record<string, RouteTaxonomyEntry> = {
  'informant:intel': {
    ...
    label: '情报链',
    supportRelicIds: ['wiretap_rosary', 'black_ledger', 'evidence_furnace', 'codex_chip', 'cipher_lantern'],
  },
  'informant:stealth': {
    routeTag: 'informant:stealth',
    characterId: 'informant',
    label: '潜行链',
    supportRelicIds: ['surgical_lens', 'silent_beads', 'mirror_ink', 'grave_oil', 'cipher_lantern'],
  },
  'informant:evidence': {
  ...
  'brute:strength': {
    ...
    characterId: 'brute',
    label: '力量链',
    supportRelicIds: ['vajra', 'ember_pin', 'reactive_incense', 'sacred_reactor_shard', 'iron_votive'],
  },
  'brute:block': {
    routeTag: 'brute:block',
    characterId: 'brute',
    label: '护甲链',
    supportRelicIds: ['anchor', 'seal_of_defiance', 'coolant_spine', 'penitent_cooling_mask', 'iron_votive'],
  },
  'brute:rage': {
    routeTag: 'brute:rage',
    characterId: 'brute',
    label: '怒意链',
    supportRelicIds: ['blood_ram', 'burning_blood', 'martyrs_censer', 'reactive_incense', 'iron_votive'],
  },
  'tactician:poison': {
    routeTag: 'tactician:poison',
    characterId: 'tactician',
    label: '毒性链',
    supportRelicIds: ['venom_alembic', 'attrition_engine', 'fatal_index', 'fracture_lens', 'command_seal'],
  },
  'tactician:command': {
    routeTag: 'tactician:command',
    characterId: 'tactician',
    label: '号令链',
    supportRelicIds: ['command_pin', 'palace_abacus', 'court_tax', 'regent_seal', 'command_seal'],
  },
  'tactician:formation': {
    routeTag: 'tactician:formation',
    characterId: 'tactician',
    label: '阵列链',
    supportRelicIds: ['bag_of_prep', 'servo_abacus', 'verdict_cog', 'abbot_sealant', 'command_seal'],
  },
  'puppeteer:threads': {
    routeTag: 'puppeteer:threads',
    characterId: 'puppeteer',
    label: '丝线链',
    supportRelicIds: ['silver_threads', 'servo_abacus', 'dream_sheath', 'codex_chip', 'marionette_reliquary'],
  },
  'puppeteer:summon': {
    routeTag: 'puppeteer:summon',
    characterId: 'puppeteer',
    label: '召构链',
    supportRelicIds: ['silver_threads', 'shard_lantern', 'dream_sheath', 'funeral_dynamo', 'marionette_reliquary'],
  },
  'puppeteer:sacrifice': {
    routeTag: 'puppeteer:sacrifice',
    characterId: 'puppeteer',
    label: '献祭链',
    supportRelicIds: ['seal_of_martyrdom', 'martyr_coin', 'purge_hook', 'funeral_dynamo', 'marionette_reliquary'],
  },
  'chronomancer:time_layer': {
  ...
  'chronomancer:delay': {
    ...
    characterId: 'chronomancer',
    label: '延时链',
    supportRelicIds: ['cracked_hourglass', 'echo_buckle', 'shortcut_compass', 'prophetic_eye', 'minute_censer'],
  },
  'chronomancer:warp': {
  ...
  'alchemist:fire': {
    ...
    label: '火相链',
    supportRelicIds: ['ember_pin', 'sacred_reactor_shard', 'reactive_incense', 'prism_crucible', 'crucible_choir'],
  },
  'alchemist:acid': {
    routeTag: 'alchemist:acid',
    characterId: 'alchemist',
    label: '酸蚀链',
    supportRelicIds: ['venom_alembic', 'attrition_engine', 'dissolution_crucible', 'cooling_retort', 'crucible_choir'],
  },
  'alchemist:concoction': {
    routeTag: 'alchemist:concoction',
    characterId: 'alchemist',
    label: '配方链',
    supportRelicIds: ['dissolution_crucible', 'prism_crucible', 'cooling_retort', 'evidence_furnace', 'crucible_choir'],
  },
  'penitent_judge:verdict': {
    routeTag: 'penitent_judge:verdict',
    characterId: 'penitent_judge',
    label: '判令链',
    supportRelicIds: ['mortuary_warrant', 'confessor_sigil', 'blackened_gavel', 'verdict_thurible'],
  },
  'penitent_judge:execution': {
    routeTag: 'penitent_judge:execution',
    characterId: 'penitent_judge',
    label: '处刑链',
    supportRelicIds: ['blackened_gavel', 'mortuary_warrant', 'surgical_lens', 'verdict_thurible'],
  },
  'penitent_judge:confession': {
    routeTag: 'penitent_judge:confession',
    characterId: 'penitent_judge',
    label: '供述链',
    supportRelicIds: ['confessor_sigil', 'wiretap_rosary', 'black_ledger', 'verdict_thurible'],
  },
  'void_sanctioner:seal': {
    routeTag: 'void_sanctioner:seal',
    characterId: 'void_sanctioner',
    label: '封印链',
    supportRelicIds: ['void_anchor_litany', 'nullglass_lens', 'cage_bell_clapper', 'null_chalice'],
  },
  'void_sanctioner:suppression': {
    routeTag: 'void_sanctioner:suppression',
    characterId: 'void_sanctioner',
    label: '压制链',
    supportRelicIds: ['cage_bell_clapper', 'void_anchor_litany', 'nullglass_lens', 'anchor', 'null_chalice'],
  },
  'void_sanctioner:risk': {
    routeTag: 'void_sanctioner:risk',
    characterId: 'void_sanctioner',
    label: '代价链',
    supportRelicIds: ['nullglass_lens', 'sacred_reactor_shard', 'ruined_reactor', 'null_chalice'],
  },
};
