...
const ALLOWED_RAW_GAMEPLAY_IMPORTERS = new Set([
  ...
  'scripts/validation/check_asset_polish.ts',
  'scripts/validation/check_tuanjie_asset_manifest.ts',
  'scripts/validation/contentReachabilityCheck.ts',
  'scripts/validation/deepReachabilityCheck.ts',
  'scripts/validation/flow_smoke_helpers.ts',
  'scripts/validation/playwright_ui_smoke_expansion.ts',
  'scripts/validation/contentBundleCheck.ts',
  'scripts/validation/longform_balance_playtest.ts',
  'scripts/validation/translation_audit.ts',
  'tests/unit/alchemistStarterLoop.test.ts',
  'tests/unit/gothicExpansionContent.test.ts',
  'tests/unit/informantStarterLoop.test.ts',
  'tests/unit/runtimeV2Parity.test.ts',
